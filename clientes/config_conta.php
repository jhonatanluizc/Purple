				...
				<form class="mt-5" method="post" action="atualizando_conta.php" >
					...
					<div class="row">
						<div class="col mt-4">
							...
							<input required id="datanascimento" min="1900-01-01" max="<?php $date = date('Y-m-d'); echo("$date") ?>" name="datanascimento" type="date" value="<?php echo $datanascimento ?>" class="form-control form-control-lg">
						</div>

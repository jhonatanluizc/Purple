	...
	<div id="wrap">
		<div id="main">
			...
			<div class="container" style="color: white;">
				<form class="mt-5" method="post" action="reparar_senha.php">
					...
					<div class="row">
						<div class="col mt-4">
							...
							<input required name="datanascimento" min="1900-01-01" max="<?php $date = date('Y-m-d');
																						echo ("$date") ?>" type="date" class="form-control form-control-lg">
						</div>

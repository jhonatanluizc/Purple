...
<head>
	...
	<!-- Fontawesome -->
	<link rel="stylesheet" href="../Public/vendor/fontawesome/font/fa-solid.css">
	<link rel="stylesheet" href="../Public/vendor/fontawesome/font/fontawesome.css">
	<link rel="stylesheet" href="../Public/vendor/fontawesome/font/fa-brands.css">
	<!-- Grayscale CSS -->
	<link href="../Public/vendor/css/grayscale.css" rel="stylesheet">
...
<body>
	<div id="wrap">
		...
		<div class="container">
			<div style="margin-top: 100px; margin-bottom: 40px; " align="center">
				...
				<div>
					<h3><b id=dest_sem>&nbsp;Mais Vendidos da Semana&nbsp;</b></h3>
				</div>
			</div>
		...
		<div class="container">
			...
			<div style="margin-top: -50px; margin-bottom: 40px; " align="center">
				<div>
					<h3><b id=dest_sem>&nbsp;Produtos em Destaque&nbsp;</b></h3>
				</div>
			</div>
	...
	<!-- Grayscale JS -->
	<script src="../Public/vendor/js/grayscale.js"></script>
